...
function Navbar() {
  ...
  return (
    <nav id="navbar">
      ...
      <a href="https://github.com/mittal0802" target="_blank" className="icons">
      ...
      <div className="Introduction">
        ...
        <p>
          I'm a Final year software engineering student at DTU seeking many ways
          to improve my skills through problem-solving and creating various
          projects! Scroll down to learn more about me.
        </p>
